...
import { getExpenseReport } from '@/features/reports/server/report.actions';
...
export async function GET(req: NextRequest) {
  try {
    ...
    return csvResponse(csv, `relatorio-saidas-${suffix}.csv`);
  } catch (error: any) {
    console.error('[REPORT_EXPENSES_CSV_ERROR]', error);
